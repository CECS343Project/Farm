...
public class NewPatient 
{
	public VerticalPanel getPanel()
	{
		...
		ftPatientInfo.setWidget(4, 1, pDOB);
		...
		ftPatientInfo.setWidget(6, 5, lbFrequency);
		...
		ftPatientInfo.setWidget(8, 2, lMedEndDate);
		ftPatientInfo.setWidget(8, 3, tbMedEndDate);	
